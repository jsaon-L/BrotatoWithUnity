...
namespace StarForce
{
    public class ProcedureCheckVersion : ProcedureBase
    {
        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            Debug.Log("m_NeedUpdateVersion:"+ m_NeedUpdateVersion);
        ...
        private void OnWebRequestSuccess(object sender, GameEventArgs e)
        {
            ...
            {
                // 需要强制更新游戏应用
                GameEntry.UIStack.OpenBuiltinDialog(new DialogParams<object>
                {
                    Mode = 2,
                    Title = "强制更新",
                    Message = "当前版本过旧，是否前往更新？",
                    ConfirmText = "更新",
                    OnClickConfirm = GotoUpdateApp,
                    CancelText ="退出",
                    OnClickCancel = delegate (DialogResule<object> _) { UnityGameFramework.Runtime.GameEntry.Shutdown(ShutdownType.Quit); },
                });
