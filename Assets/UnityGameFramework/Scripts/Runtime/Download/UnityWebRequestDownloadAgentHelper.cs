...
namespace UnityGameFramework.Runtime
{
    ...
    public partial class UnityWebRequestDownloadAgentHelper : DownloadAgentHelperBase, IDisposable
    {
        ...
        {
            float progress = m_UnityWebRequest.downloadProgress;
            if (m_Progress != progress)
            {
                m_Progress = progress;
                DownloadAgentHelperProgressEventArgs downloadAgentHelperCompleteEventArgs = DownloadAgentHelperProgressEventArgs.Create(m_Progress);
                m_DownloadAgentHelperProgressEventHandler(this, downloadAgentHelperCompleteEventArgs);
                ReferencePool.Release(downloadAgentHelperCompleteEventArgs);
            }
