...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class DownloadComponent : GameFrameworkComponent
    {
        ...
        private void OnDownloadProgress(object sender, GameFramework.Download.DownloadProgressEventArgs e)
        {
            m_EventComponent.Fire(this, DownloadProgressEventArgs.Create(e));
        }
