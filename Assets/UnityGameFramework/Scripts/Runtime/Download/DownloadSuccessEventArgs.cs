...
namespace UnityGameFramework.Runtime
{
    ...
    /// 下载成功事件。
    /// </summary>
    public sealed class DownloadProgressEventArgs : GameEventArgs
    {
        /// <summary>
        /// 下载成功事件编号。
        /// </summary>
        ...
        /// <param name="e">内部事件。</param>
        /// <returns>创建的下载成功事件。</returns>
        public static DownloadProgressEventArgs Create(GameFramework.Download.DownloadProgressEventArgs e)
        {
            ...
            downloadSuccessEventArgs.CurrentLength = e.CurrentLength;
            downloadSuccessEventArgs.UserData = e.UserData;
            downloadSuccessEventArgs.Progress = e.Progress;
            return downloadSuccessEventArgs;
        }
