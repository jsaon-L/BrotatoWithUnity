...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class WebRequestComponent : GameFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_WebRequestManager.WebRequestProgress += OnWebRequestProgress;
        }
        ...
        private void OnWebRequestProgress(object sender, GameFramework.WebRequest.WebRequestProgressEventArgs e)
        {
            m_EventComponent.Fire(this, WebRequestProgressEventArgs.Create(e));
        }
