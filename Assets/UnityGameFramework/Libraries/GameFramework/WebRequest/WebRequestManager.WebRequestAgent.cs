...
namespace GameFramework.WebRequest
{
    internal sealed partial class WebRequestManager : GameFrameworkModule, IWebRequestManager
    {
        ...
        private sealed class WebRequestAgent : ITaskAgent<WebRequestTask>
        {
            ...
            public GameFrameworkAction<WebRequestAgent, float> WebRequestAgentProgress;
            ...
            public void Initialize()
            {
                ...
                m_Helper.WebRequestAgentHelperProgress += OnWebRequestAgentHelperProgress;
            }
            ...
            private void OnWebRequestAgentHelperProgress(object sender, WebRequestAgentHelperProgressEventArgs e)
            {

                if (WebRequestAgentProgress != null)
                {
                    WebRequestAgentProgress(this, e.GetWebProgress());
                }
