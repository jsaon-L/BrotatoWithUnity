...
namespace GameFramework.WebRequest
{
    ...
    internal sealed partial class WebRequestManager : GameFrameworkModule, IWebRequestManager
    {
        ...
        private EventHandler<WebRequestProgressEventArgs> m_WebRequestProgressEventHandler;
        ...
        public WebRequestManager()
        {
            ...
            m_WebRequestProgressEventHandler = null;
        ...
        public event EventHandler<WebRequestProgressEventArgs> WebRequestProgress
        {
            add
            {
                m_WebRequestProgressEventHandler += value;
            }
            remove
            {
                m_WebRequestProgressEventHandler -= value;
        ...
        public void AddWebRequestAgentHelper(IWebRequestAgentHelper webRequestAgentHelper)
        {
            ...
            agent.WebRequestAgentProgress += OnWebRequestAgentProgress;
        ...
        private void OnWebRequestAgentProgress(WebRequestAgent sender, float progress)
        {
            if (m_WebRequestProgressEventHandler != null)
            {
                WebRequestProgressEventArgs webRequestSuccessEventArgs = WebRequestProgressEventArgs.Create(sender.Task.SerialId, sender.Task.WebRequestUri, progress, sender.Task.UserData);
                m_WebRequestProgressEventHandler(this, webRequestSuccessEventArgs);
                ReferencePool.Release(webRequestSuccessEventArgs);
            }
        }
