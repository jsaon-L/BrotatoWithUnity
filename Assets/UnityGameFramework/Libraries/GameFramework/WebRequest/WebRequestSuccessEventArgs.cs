...
namespace GameFramework.WebRequest
{
    ...
    /// Web 请求成功事件。
    /// </summary>
    public sealed class WebRequestProgressEventArgs : GameFrameworkEventArgs
    {
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>创建的 Web 请求成功事件。</returns>
        public static WebRequestProgressEventArgs Create(int serialId, string webRequestUri, float progress, object userData)
        {
            WebRequestProgressEventArgs webRequestSuccessEventArgs = ReferencePool.Acquire<WebRequestProgressEventArgs>();
            webRequestSuccessEventArgs.SerialId = serialId;
            webRequestSuccessEventArgs.WebRequestUri = webRequestUri;
            webRequestSuccessEventArgs.m_WebProgress = progress;
            webRequestSuccessEventArgs.UserData = userData;
            return webRequestSuccessEventArgs;
        }
