    ...
    internal sealed partial class DownloadManager : GameFrameworkModule, IDownloadManager
    {
        ...
        private sealed class DownloadAgent : ITaskAgent<DownloadTask>, IDisposable
        {
            ...
            public void Initialize()
            {
                ...
                m_Helper.DownloadAgentHelperProgress += OnDownloadAgentHelperProgress;
            ...
            private void OnDownloadAgentHelperProgress(object sender, DownloadAgentHelperProgressEventArgs e)
            {
               if (DownloadAgentProgress != null) {

                    DownloadAgentProgress(this, e.Progress);
                }
            }
