...
namespace GameFramework.Download
{
    ...
    internal sealed partial class DownloadManager : GameFrameworkModule, IDownloadManager
    {
        ...
        private EventHandler<DownloadProgressEventArgs> m_DownloadProgressEventHandler;
        ...
        public DownloadManager()
        {
            ...
            m_DownloadProgressEventHandler = null;
        ...
        public event EventHandler<DownloadProgressEventArgs> DownloadProgress
        {
            add
            {
                m_DownloadProgressEventHandler += value;
            }
            remove
            {
                m_DownloadProgressEventHandler -= value;
        ...
        public void AddDownloadAgentHelper(IDownloadAgentHelper downloadAgentHelper)
        {
            ...
            agent.DownloadAgentProgress += OnDownloadAgentProgress;
        ...
        private void OnDownloadAgentProgress(DownloadAgent sender, float progress)
        {
            if (m_DownloadSuccessEventHandler != null)
            {
                DownloadProgressEventArgs downloadSuccessEventArgs = DownloadProgressEventArgs.Create(sender.Task.SerialId, sender.Task.DownloadPath, sender.Task.DownloadUri, sender.CurrentLength, sender.Task.UserData,progress);
                m_DownloadProgressEventHandler(this, downloadSuccessEventArgs);
                ReferencePool.Release(downloadSuccessEventArgs);
            }
        }
