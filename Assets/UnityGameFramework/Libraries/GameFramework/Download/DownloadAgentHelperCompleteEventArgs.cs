...
namespace GameFramework.Download
{
    ...
    /// 下载代理辅助器完成事件。
    /// </summary>
    public sealed class DownloadAgentHelperProgressEventArgs : GameFrameworkEventArgs
    {
        /// <summary>
        /// 初始化下载代理辅助器完成事件的新实例。
        /// </summary>
        ...
        /// <param name="length">下载的数据大小。</param>
        /// <returns>创建的下载代理辅助器完成事件。</returns>
        public static DownloadAgentHelperProgressEventArgs Create(float progress)
        {
            

            DownloadAgentHelperProgressEventArgs downloadAgentHelperCompleteEventArgs = ReferencePool.Acquire<DownloadAgentHelperProgressEventArgs>();
            downloadAgentHelperCompleteEventArgs.Progress = progress;
            return downloadAgentHelperCompleteEventArgs;
        }
