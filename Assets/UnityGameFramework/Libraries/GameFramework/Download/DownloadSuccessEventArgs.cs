...
namespace GameFramework.Download
{
    ...
    public sealed class DownloadProgressEventArgs : GameFrameworkEventArgs
    {
        /// <summary>
        /// 初始化下载成功事件的新实例。
        /// </summary>
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>创建的下载成功事件。</returns>
        public static DownloadProgressEventArgs Create(int serialId, string downloadPath, string downloadUri, long currentLength, object userData,float progress)
        {
            DownloadProgressEventArgs downloadSuccessEventArgs = ReferencePool.Acquire<DownloadProgressEventArgs>();
            downloadSuccessEventArgs.SerialId = serialId;
            downloadSuccessEventArgs.DownloadPath = downloadPath;
            downloadSuccessEventArgs.DownloadUri = downloadUri;
            downloadSuccessEventArgs.CurrentLength = currentLength;
            downloadSuccessEventArgs.UserData = userData;
            downloadSuccessEventArgs.Progress = progress;
            return downloadSuccessEventArgs;
        }
